...
from configurations import res_x, res_y, fov_x, fov_y, cam_outfov_pos, cam_outfov_xy_axes, table_intresest_points
...
if __name__ == '__main__':
    ...
    cam_pos = cam_outfov_pos
    cam_frame_rotation = xy_axes_to_frame_rotation(cam_outfov_xy_axes[0], cam_outfov_xy_axes[1])

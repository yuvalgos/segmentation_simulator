...
from configurations import res_x, res_y, fov_x, fov_y, cam_2_pos, cam_2_xy_axes, pole_interest_points
...
if __name__ == '__main__':
    ...
    cam_pos = cam_2_pos
    cam_frame_rotation = xy_axes_to_frame_rotation(cam_2_xy_axes[0], cam_2_xy_axes[1])
    ...
    interest_points = pole_interest_points
    ...
    cam_sim = CameraSimulator(resolution=(res_x, res_y), fovy=fov_y ,launch_viewer=False,
                              world_file="./data/world_pole.xml")
